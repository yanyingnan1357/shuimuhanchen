$(document).ready(function () {
    ...
    $.ajax({
        ...
        url: "http://localhost:9797/api/category/list",
        type: "GET",
        dataType: "json",
    ...
    $.ajax({
        ...
        url: "http://localhost:9797/api/article/list",
        dataType: "json",
        success: function (json) {
            $.each(json, function (i, item) {
...
document.getElementById("articleCategories").onchange = function () {
    ...
    if (categoryId === "") {
        ...
        var url = "http://localhost:9797/api/article/list";
    } else {
        var url = "http://localhost:9797/api/article/list/sort/" + categoryId;
    }
    // 填充博文分类信息
    $.ajax({
        url: url,
...
$('#confirmBtn').click(function () {
    ...
    $.ajax({
        type: "DELETE",
        url: "http://localhost:9797/admin/article/" + id,
        success: function () {
            // 刷新页面
            location.reload();
        }
...
$('#updateBtn').click(function () {
    ...
    $.ajax({
        type: "PUT",
        url: "http://localhost:9797/admin/article/" + articleId,
        dataType: "json",
...
$('#addArticleBtn').click(function () {
    ...
    $.ajax({
        type: "POST",
        url: "http://localhost:9797/admin/article/",
        dataType: "json",
        contentType: "application/json;charset=utf-8",
        data: JSON.stringify(article),
        success: function () {
